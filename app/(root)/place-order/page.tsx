...
import { assertApiSuccess, formatCurrency } from "@/lib/utils/utils";
          ...
          <Card>
            {userAddress.shippingMethod === "DELIVERY" ? (
              <CardContent className="p-4 gap-4">
                ...
                <p className="font-medium">{userAddress.address.fullName}</p>
                <p>
                  {userAddress.address.streetName}, {userAddress.address.city},{" "}
                  {userAddress.address.state} {userAddress.address.postalCode},{" "}
